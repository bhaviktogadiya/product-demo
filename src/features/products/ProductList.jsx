    ...
    return(
        data?.map((product,index)=>{
            ...
            <div className="text-box">
                ...
                <p style={{fontSize:'12px'}} className="description" title={product?.description}>{product?.description?.length > 40 ? `${product.description.slice(0,40)}...`:product?.description}</p>
